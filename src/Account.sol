...
contract Account is ERC4337 {
    ...
    /// bytes32 internal constant _VALIDATE_TYPEHASH =keccak256("ValidateUserOp(address sender,uint256 nonce,bytes initCode,bytes callData,bytes32 accountGasLimits,uint256 preVerificationGas,bytes32 gasFees,bytes paymasterAndData,uint48 validUntil,uint48 validAfter)");
    ...
    function _validateUserOpSignature(PackedUserOperation calldata userOp)
        ...
        returns (uint256)
    {
        //The timeframe in which the operation is valid.
